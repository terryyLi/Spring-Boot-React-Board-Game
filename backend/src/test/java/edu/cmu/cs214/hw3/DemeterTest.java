...
public class DemeterTest {
    ...
    public void simplyBuildTwice() {
        ...
        Player player1 = new Demeter(new Worker(new Position(0, 0), 1), new Worker(new Position(1, 0), 2), board1, 1);
        boolean build1 = player1.build(player1.getWorker1(), new Position(1, 1));
        boolean build2 = player1.build(player1.getWorker1(), new Position(0, 1));
        assertTrue(build1 & build2);
        assertEquals(player1.getBoard().getTowerLevel(new Position(1, 1)), 1);
        assertEquals(player1.getBoard().getTowerLevel(new Position(0, 1)), 1);
    }

    @Test
    public void buildFailOnPrevBuild() {
        Board board1 = new Board(5, 5, 4);
        Player player1 = new Demeter(new Worker(new Position(0, 0), 1), new Worker(new Position(1, 0), 2), board1, 1);
        boolean build1 = player1.build(player1.getWorker1(), new Position(1, 1));
        boolean buildFail = player1.build(player1.getWorker1(), new Position(1, 1));
        boolean build2 = player1.build(player1.getWorker1(), new Position(0, 1));
