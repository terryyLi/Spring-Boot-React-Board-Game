...
public class ApolloTest {
    @Test
    public void moveIntoOpponent() {
        Board board1 = new Board(5, 5, 4);
        Player player1 = new Apollo(new Worker(new Position(0, 0), 1), new Worker(new Position(1, 0), 2), board1, 1);
        Player player2 = new Apollo(new Worker(new Position(0, 1), 1), new Worker(new Position(1, 1), 2), board1, 2);
        ...
        assertEquals(player2.getWorker2().getPosition().getX(), 0);
        assertEquals(player2.getWorker2().getPosition().getY(), 0);
    }
