...
public class HephaestusTest {
    @Test
    public void simplyBuildTwice() {
        Board board1 = new Board(5, 5, 4);
        Player player1 = new Hephaestus(new Worker(new Position(0, 0), 1), new Worker(new Position(1, 0), 2), board1, 1);
        ...
        assertTrue(build1 && build2);
        assertEquals(player1.getBoard().getTowerLevel(new Position(1, 1)), 2);
    }

    @Test
    public void buildFailOnOtherPlace() {
        Board board1 = new Board(5, 5, 4);
        Player player1 = new Hephaestus(new Worker(new Position(0, 0), 1), new Worker(new Position(1, 0), 2), board1, 1);
        boolean build1 = player1.build(player1.getWorker1(), new Position(1, 1));
        boolean buildFail = player1.build(player1.getWorker1(), new Position(1, 2));
        boolean build2 = player1.build(player1.getWorker1(), new Position(1, 1));
        assertTrue(build1 && build2 && !buildFail);
        assertEquals(player1.getBoard().getTowerLevel(new Position(1, 1)), 2);
    }
    ...
    @Test
    public void moveUHephaestusdWin() {
        Board board1 = new Board(5, 5, 4);
        Player player1 = new Hephaestus(new Worker(new Position(0, 0), 1), new Worker(new Position(1, 0), 2), board1, 1);
        player1.getBoard().incrTowerLevel(new Position(0, 0));
        player1.getBoard().incrTowerLevel(new Position(0, 0));
